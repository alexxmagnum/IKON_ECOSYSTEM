...
Definir el modelo de dominio de IKON.
...
El esquema físico de PostgreSQL se definirá posteriormente en `24_DATABASE_SCHEMA.md`.
...
Cada entidad representa un concepto real del ecosistema IKON.

---

# Entidad: Usuario

Representa cualquier persona registrada en IKON.
